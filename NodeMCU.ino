...
unsigned long myChannel = 2563465;
const char *writeAPIKey = "BA8UC9Q295FBDYQC";
const char *talkBackAPIKey = "LCSY4R7Z601WMH10";
const char *talkBackID = "52385";
int fieldTempAmbiente = 1;
int fieldHumAmbiente = 2;
int fieldHumSuelo = 3;
int fieldValorLDR = 4;
...
void processPacket(String packet) {
  ...
  Serial.print("Temperatura ambiente: "); Serial.println(numbers[0]);
  Serial.print("Humedad ambiente: "); Serial.println(numbers[1]);
  Serial.print("Humedad del suelo: "); Serial.println(numbers[2]);
  Serial.print("Valor del sensor de luz: "); Serial.println(numbers[3]);
